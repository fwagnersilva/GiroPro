...
describe('Database Setup Diagnostic', function () {
    it('deve verificar se as tabelas foram criadas', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, allTables, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error('❌ Erro no diagnóstico:', error_1);
                    throw error_1;
