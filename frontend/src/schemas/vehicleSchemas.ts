...
export const vehicleSchema = z.object({
  ...
  tipoCombustivel: z.enum(["Gasolina", "Etanol", "Diesel", "GNV", "Flex"], { required_error: "O tipo de combustível é obrigatório." }),
  tipoUso: z.enum(["Proprio", "Alugado", "Financiado"], { required_error: "O tipo de uso é obrigatório." }),
});
